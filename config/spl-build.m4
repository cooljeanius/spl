...
AC_DEFUN([SPL_AC_KERNEL],[
	...
	AS_IF([test -z "$KERNEL_HEADERS"],[
		AS_IF([test -d "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/System/Library/Frameworks/Kernel.framework"],[
			KERNEL_HEADERS="/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/System/Library/Frameworks/Kernel.framework"
		])
	])
	AS_IF([test -z "$KERNEL_HEADERS"],[
